<template><div><el-collapse>
<el-collapse-item title="前言" name="1">
<p>随着前端项目不断扩大，浏览器渲染的压力变得越来越重。配置好一点的计算机可以顺利地展现页面；配置低一些的计算机<code v-pre>渲染页面</code>的性能就不那么可观了。</p>
...
<p><code v-pre>&lt;meta name=viewport content=width=device=width,initial-scale=1&gt;</code></p>
...
<ul>
<li><code v-pre>webkit-transform: translate 3d(0, 0, 0);</code></li>
<li><code v-pre>-moz-transform: translate3d(0,0, 0);</code></li>
<li><code v-pre>-ms-transform: translate 3d(0,0,0);</code></li>
<li><code v-pre>transform: translate3d(0,0,0);</code></li>
</ul>
...
<ul>
<li><code v-pre>-webkit-backface-visibility: hidden;</code></li>
<li><code v-pre>-moz-backface-visibility: hidden;</code></li>
<li><code v-pre>-ms-backface-visibility: hidden;</code></li>
<li><code v-pre>backface-visibility: hidden;</code></li>
<li><code v-pre>-webkit-perspective：1000;</code></li>
<li><code v-pre>-moz-perspective：1000;</code></li>
<li><code v-pre>-ms-perspective：1000;</code></li>
<li><code v-pre>perspective：1000;</code></li>
</ul>
<p>（2）尽可能少使用box- shadows和 gradients，它们往往严重影响页面的性能，尤其是在一个元素中同时都使用时。（3）尽可能让动画元素脱离文档流，以减少重排，如以下代码所示。</p>
<ul>
<li><code v-pre>position: fixed;</code></li>
<li><code v-pre>position: absolute;</code></li>
</ul>
</el-collapse-item>
</el-collapse>
</div></template>
