<template><div><h2 id="远程连接问题" tabindex="-1"><a class="header-anchor" href="#远程连接问题" aria-hidden="true">#</a> 远程连接问题</h2>
...
<h2 id="查看网卡配置" tabindex="-1"><a class="header-anchor" href="#查看网卡配置" aria-hidden="true">#</a> 查看网卡配置</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">cd</span> /etc/sysconfig/network-scripts/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="按时间显示文件" tabindex="-1"><a class="header-anchor" href="#按时间显示文件" aria-hidden="true">#</a> 按时间显示文件</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">ls</span> <span class="token parameter variable">-lrt</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="查看具体网卡信息" tabindex="-1"><a class="header-anchor" href="#查看具体网卡信息" aria-hidden="true">#</a> 查看具体网卡信息</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">ifconfig</span> -a｜more
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="查看eth0的配置" tabindex="-1"><a class="header-anchor" href="#查看eth0的配置" aria-hidden="true">#</a> 查看eth0的配置</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">vi</span> ifcfg-eth0
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="配置ip、子网掩码、网关" tabindex="-1"><a class="header-anchor" href="#配置ip、子网掩码、网关" aria-hidden="true">#</a> 配置IP、子网掩码、网关</h2>
<h3 id="重启网卡" tabindex="-1"><a class="header-anchor" href="#重启网卡" aria-hidden="true">#</a> 重启网卡</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">service</span> network restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">BOOTPROTO</span><span class="token operator">=</span>static        
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token assign-left variable">DEVICE</span><span class="token operator">=</span>ens33                         
