...
<h2 id="常量定义" tabindex="-1"><a class="header-anchor" href="#常量定义" aria-hidden="true">#</a> 常量定义</h2>
<h3 id="empty-obj、empty-arr-对象" tabindex="-1"><a class="header-anchor" href="#empty-obj、empty-arr-对象" aria-hidden="true">#</a> EMPTY_OBJ、EMPTY_ARR 对象</h3>
<p>typescript是通过 <code v-pre>readonly</code> 的方式来定义一个冻结对象的类型的， <code v-pre>readonly</code> 是只读修饰符。 <code v-pre>Object.freeze</code> 冻结对象属性功能。</p>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="noop-空函数" tabindex="-1"><a class="header-anchor" href="#noop-空函数" aria-hidden="true">#</a> NOOP 空函数</h3>
<p>定义一个空函数，而不是 <code v-pre>function () {}</code> 这样定义，是为了方便压缩。</p>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="torawtype-取出数据类型" tabindex="-1"><a class="header-anchor" href="#torawtype-取出数据类型" aria-hidden="true">#</a> toRawType 取出数据类型</h3>
<p>这里需要注意的是前面的 <code v-pre>toTypeString</code> 返回了 <code v-pre>[object xxType]</code>，现在则是使用 <code v-pre>slice</code> 方法来将 <code v-pre>xxType</code> 取出</p>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ison-事件名on判断" tabindex="-1"><a class="header-anchor" href="#ison-事件名on判断" aria-hidden="true">#</a> isOn 事件名on判断</h3>
<p>利用正则来判断当前的事件名是否是 <code v-pre>on + EventName</code> 的格式</p>
<p>注意: <code v-pre>^</code> 在正则开头表示首位占位符，其他地方都是非的含义，<code v-pre>[^a-z]</code> 表示不是 a 到 z 的字母</p>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="remove-删除数组元素" tabindex="-1"><a class="header-anchor" href="#remove-删除数组元素" aria-hidden="true">#</a> remove 删除数组元素</h3>
...
<h3 id="hasown-是否包含属性" tabindex="-1"><a class="header-anchor" href="#hasown-是否包含属性" aria-hidden="true">#</a> hasOwn 是否包含属性</h3>
<p>判断一个属性是否是一个对象本身的属性，利用了 <code v-pre>Object.prototype.hasOwnProperty.call</code> 的形式来实现功能</p>
<ul>
<li>源码实现</li>
</ul>
...
<h3 id="isarray-是否数组" tabindex="-1"><a class="header-anchor" href="#isarray-是否数组" aria-hidden="true">#</a> isArray 是否数组</h3>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="ismap-isset-是否map-set" tabindex="-1"><a class="header-anchor" href="#ismap-isset-是否map-set" aria-hidden="true">#</a> isMap/isSet 是否Map/Set</h3>
<ul>
<li>源码实现</li>
</ul>
...
<blockquote>
<p><code v-pre>get</code> 获取元素，
<code v-pre>set</code> 新增元素成员，
<code v-pre>has</code> 是否包含某元素，
<code v-pre>delete</code> 删除元素成员，
...
<ul>
<li>Map的键可以是<code v-pre>任意类型</code>, Object只能是 <code v-pre>String</code> 或者 <code v-pre>Symbol</code></li>
<li>Map的可以通过<code v-pre>size</code>属性获取元素数量, Object则必须<code v-pre>手动计算</code></li>
<li>Map在频繁<code v-pre>增减键值对</code>的场景下, <code v-pre>性能较好</code></li>
<li>Map中的数据是<code v-pre>有序</code>的, 而Object则是<code v-pre>无序</code>的
:::</li>
</ul>
<h4 id="set" tabindex="-1"><a class="header-anchor" href="#set" aria-hidden="true">#</a> Set</h4>
<p>Set类型是<code v-pre>es6</code>提供的一种新的数据类型，它允许你存入 <code v-pre>任意类型</code> 的 <code v-pre>唯一值</code> ，无论是 <code v-pre>基本数据类型</code> 还是 <code v-pre>引用类型</code> ，尽管NaN !== NaN，Set仍然认为这是同一个数据。</p>
<ul>
<li>基础方法</li>
</ul>
<blockquote>
<p><code v-pre>add</code> 新增元素成员，
<code v-pre>has</code> 是否包含某元素，
<code v-pre>delete</code> 删除元素成员，
<code v-pre>clear</code> 清空所有元素，
 ...
 * item { name: '小明' }
 */
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="isdate-是否时间" tabindex="-1"><a class="header-anchor" href="#isdate-是否时间" aria-hidden="true">#</a> isDate 是否时间</h3>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="isfunction-是否函数" tabindex="-1"><a class="header-anchor" href="#isfunction-是否函数" aria-hidden="true">#</a> isFunction 是否函数</h3>
<ul>
<li>源码实现</li>
</ul>
...
<blockquote>
<p><code v-pre>typeof null === 'object'</code>，所以必须确保val不为null。</p>
<p><code v-pre>Record</code>是 <code v-pre>typescript</code> 中的一种工具类型，它的作用是限制一个对象的键值类型，其两个泛型参数就是一个限制键类型，一个限制值类型。</p>
</blockquote>
<ul>
<li>源码实现</li>
</ul>
...
<h3 id="isplainobject-是否纯粹对象" tabindex="-1"><a class="header-anchor" href="#isplainobject-是否纯粹对象" aria-hidden="true">#</a> isPlainObject 是否纯粹对象</h3>
<p>该方法作用是，判断一个对象<code v-pre>是否是纯粹的对象</code>，前面一个isObject方法，<code v-pre>isObject([])是true</code>，<code v-pre>isObject({})也是true</code>，而此处的isPlainObject则仅限于真正的Object。</p>
<ul>
<li>源码实现</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由此我们得知, parseInt最多只能取到36!</p>
</div>
<h3 id="makemap-构造带逗号的字符串校验字符函数" tabindex="-1"><a class="header-anchor" href="#makemap-构造带逗号的字符串校验字符函数" aria-hidden="true">#</a> makeMap 构造带逗号的字符串校验字符函数</h3>
<p>该方法主要是接收一个<code v-pre>带逗号的字符串</code>，将该字符串以<code v-pre>逗号拆分</code>为一个个子字符串，再用这些子字符串作为一个对象的<code v-pre>键</code>，<code v-pre>值全部为true</code>；返回一个方法，这个方法可以检测出这个方法接收的参数是否是对象中的键。</p>
<ul>
<li>源码实现</li>
</ul>
...
<p>类型上来看，其实就是一个这样的方法：<code v-pre>(params1:string, params2?:boolean) =&gt; (key: string) =&gt; boolean</code>，其返回了一个检测函数，该检测函数接受一个字符串，返回是该字符串是否存在！</p>
<ul>
<li>使用案例</li>
</ul>
...
<p>我们可以看到，<code v-pre>Object.create(null)</code>创建的对象更为纯粹，当方法执行到<code v-pre>map[val.toLowerCase()]</code>时，不会受到<code v-pre>__proto__</code>的影响。</p>
</div>
<h3 id="cachestringfunction-缓存结果函数" tabindex="-1"><a class="header-anchor" href="#cachestringfunction-缓存结果函数" aria-hidden="true">#</a> cacheStringFunction 缓存结果函数</h3>
<p>函数<code v-pre>返回一个函数</code>，这个函数接收<code v-pre>一个字符串</code>参数，如果第一次传入了一个参数，计算结果就会被<code v-pre>闭包``缓存</code>起来，下次再遇到相同参数的时候，就不会再走<code v-pre>fn方法重新计算</code>了。
本质上是一个<code v-pre>单例模式</code>，利用闭包，保存了之前的计算结果。</p>
<ul>
<li>源码实现</li>
</ul>
...
<h3 id="camelize-驼峰转化" tabindex="-1"><a class="header-anchor" href="#camelize-驼峰转化" aria-hidden="true">#</a> camelize 驼峰转化</h3>
<ul>
<li>源码实现</li>
</ul>
...
<p>第二个参数，它既可以是用于<code v-pre>替换掉</code>第一个参数在原字符串中的匹配部分的<code v-pre>字符串</code>（该字符串中可以内插一些<code v-pre>特殊的变量名</code>），也可以是一个用来创建新子字符串的<code v-pre>函数</code>，该函数的返回值将替换掉第一个参数匹配到的结果。</p>
</blockquote>
<ul>
<li>正则替换表达式</li>
</ul>
...
<h3 id="haschanged-比较变量相同" tabindex="-1"><a class="header-anchor" href="#haschanged-比较变量相同" aria-hidden="true">#</a> hasChanged 比较变量相同</h3>
<ul>
<li>源码实现</li>
</ul>
...
<h3 id="def-添加不可枚举属性" tabindex="-1"><a class="header-anchor" href="#def-添加不可枚举属性" aria-hidden="true">#</a> def 添加不可枚举属性</h3>
<p>就是给对象<code v-pre>obj</code>，加上一个<code v-pre>可以删除</code>，其属性描述符<code v-pre>可以改变</code>，且<code v-pre>不可枚举的属性key</code>，其值为<code v-pre>value</code>。</p>
<ul>
<li>源码实现</li>
</ul>
...
<h3 id="tonumber-尝试转换数字" tabindex="-1"><a class="header-anchor" href="#tonumber-尝试转换数字" aria-hidden="true">#</a> toNumber 尝试转换数字</h3>
<ul>
<li>源码实现</li>
</ul>
