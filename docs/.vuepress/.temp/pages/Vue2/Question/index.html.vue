...
<h3 id="vue-router实现原理的histroy相关的api" tabindex="-1"><a class="header-anchor" href="#vue-router实现原理的histroy相关的api" aria-hidden="true">#</a> vue-router实现原理的histroy相关的api</h3>
<h3 id="vue项目想要改变element-ui的组件内部的样式-默认情况下style加了scope无法修改-需怎么做" tabindex="-1"><a class="header-anchor" href="#vue项目想要改变element-ui的组件内部的样式-默认情况下style加了scope无法修改-需怎么做" aria-hidden="true">#</a> vue项目想要改变element-ui的组件内部的样式，默认情况下style加了scope无法修改，需怎么做</h3>
<h3 id="v-if-和-v-for优先级" tabindex="-1"><a class="header-anchor" href="#v-if-和-v-for优先级" aria-hidden="true">#</a> v-if 和 v-for优先级</h3>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>  <span class="token keyword">if</span> <span class="token punctuation">(</span>el<span class="token punctuation">.</span>staticRoot <span class="token operator">&amp;&amp;</span> <span class="token operator">!</span>el<span class="token punctuation">.</span>staticProcessed<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="vue渐进式" tabindex="-1"><a class="header-anchor" href="#vue渐进式" aria-hidden="true">#</a> vue渐进式</h3>
<details class="custom-container details"><summary>详情</summary>
...
<h3 id="优雅降级和渐进增强" tabindex="-1"><a class="header-anchor" href="#优雅降级和渐进增强" aria-hidden="true">#</a> 优雅降级和渐进增强</h3>
<details class="custom-container details"><summary>详情</summary>
...
<h2 id="实例选项" tabindex="-1"><a class="header-anchor" href="#实例选项" aria-hidden="true">#</a> 实例选项</h2>
<h3 id="extend-s-与mixins差异" tabindex="-1"><a class="header-anchor" href="#extend-s-与mixins差异" aria-hidden="true">#</a> extend(s)与mixins差异</h3>
<details class="custom-container details"><summary>详情</summary>
<ul>
<li>
<p><strong>Mixins 的使用方法：</strong></p>
<p>首先，我们先定义一个Mixins混入类对象。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">const</span> myMixin <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//只能使用一个extends对象，多个无效，extends会先于mixins执行</span>
...
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token comment">&lt;!--hello.vue--></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">import</span> Hello <span class="token keyword">from</span> <span class="token string">'./src/components/hello/hello'</span>
...
<h3 id="created与activated差异" tabindex="-1"><a class="header-anchor" href="#created与activated差异" aria-hidden="true">#</a> created与activated差异</h3>
<details class="custom-container details"><summary>详情</summary>
<ul>
...
<h3 id="vue的computed跟普通的函数有什么区别吗-computed怎么实现缓存的-有看过源码吗" tabindex="-1"><a class="header-anchor" href="#vue的computed跟普通的函数有什么区别吗-computed怎么实现缓存的-有看过源码吗" aria-hidden="true">#</a> vue的computed跟普通的函数有什么区别吗，computed怎么实现缓存的，有看过源码吗</h3>
<h2 id="webpack模块" tabindex="-1"><a class="header-anchor" href="#webpack模块" aria-hidden="true">#</a> webpack模块</h2>
<h3 id="webpack中-bundle-chunk-module-有什么区别" tabindex="-1"><a class="header-anchor" href="#webpack中-bundle-chunk-module-有什么区别" aria-hidden="true">#</a> webpack中 bundle chunk module 有什么区别</h3>
<h3 id="webpack中-plugin-loader-有什么区别" tabindex="-1"><a class="header-anchor" href="#webpack中-plugin-loader-有什么区别" aria-hidden="true">#</a> webpack中 plugin loader 有什么区别</h3>
</div></template>
