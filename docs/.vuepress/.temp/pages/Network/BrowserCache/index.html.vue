...
有一张来自<a href="https://www.jianshu.com/p/54cc04190252" target="_blank" rel="noopener noreferrer">《浪里行舟-深入理解浏览器的缓存机制》<ExternalLinkIcon/></a>中的图表述的非常好:</p>
<img :src="$withBase('/assets/knowledge/frontEnd/network/browserCache/001.jpg')">
<h4 id="expires和cache-control的对比" tabindex="-1"><a class="header-anchor" href="#expires和cache-control的对比" aria-hidden="true">#</a> Expires和Cache-control的对比</h4>
<ul>
...
<h4 id="last-modified-和-if-modified-since" tabindex="-1"><a class="header-anchor" href="#last-modified-和-if-modified-since" aria-hidden="true">#</a> Last-Modified 和 If-Modified-Since</h4>
...
<h4 id="etag-与-if-none-match" tabindex="-1"><a class="header-anchor" href="#etag-与-if-none-match" aria-hidden="true">#</a> ETag 与 If-None-Match</h4>
...
<h4 id="两者对比" tabindex="-1"><a class="header-anchor" href="#两者对比" aria-hidden="true">#</a> 两者对比</h4>
...
<h2 id="缓存位置" tabindex="-1"><a class="header-anchor" href="#缓存位置" aria-hidden="true">#</a> 缓存位置</h2>
...
<h3 id="service-worker" tabindex="-1"><a class="header-anchor" href="#service-worker" aria-hidden="true">#</a> Service Worker</h3>
...
<h3 id="memory-cache" tabindex="-1"><a class="header-anchor" href="#memory-cache" aria-hidden="true">#</a> Memory Cache</h3>
...
<h3 id="disk-cache" tabindex="-1"><a class="header-anchor" href="#disk-cache" aria-hidden="true">#</a> Disk Cache</h3>
...
<h3 id="push-cache" tabindex="-1"><a class="header-anchor" href="#push-cache" aria-hidden="true">#</a> Push Cache</h3>
...
<h2 id="缓存过程分析" tabindex="-1"><a class="header-anchor" href="#缓存过程分析" aria-hidden="true">#</a> 缓存过程分析</h2>
...
<h2 id="缓存策略的实际场景应用" tabindex="-1"><a class="header-anchor" href="#缓存策略的实际场景应用" aria-hidden="true">#</a> 缓存策略的实际场景应用</h2>
