<template><div><p><strong>微前端</strong> 是一种类似于微服务的架构，它将微服务的理念应用于浏览器端，即将单页面前端应用由单一的单体应用转变为多个小型前端应用聚合为一的应用。</p>
...
<h2 id="start-opts" tabindex="-1"><a class="header-anchor" href="#start-opts" aria-hidden="true">#</a> start(opts)</h2>
...
<h2 id="registermicroapps-apps-lifecycles" tabindex="-1"><a class="header-anchor" href="#registermicroapps-apps-lifecycles" aria-hidden="true">#</a> registerMicroApps(apps, lifeCycles?)</h2>
...
<h2 id="import-html-entry" tabindex="-1"><a class="header-anchor" href="#import-html-entry" aria-hidden="true">#</a> import-html-entry</h2>
...
<tbody>
<tr>
<td style="text-align:left"><code v-pre>template</code></td>
<td style="text-align:left">将脚本文件内容注释后的 <code v-pre>html</code> 模板文件</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>assetPublicPath</code></td>
<td style="text-align:left">资源地址根路径，可用于加载子应用资源</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>getExternalScripts</code></td>
<td style="text-align:left">方法：获取外部引入的脚本文件</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>getExternalStyleSheets</code></td>
<td style="text-align:left">方法：获取外部引入的样式表文件</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>execScripts</code></td>
<td style="text-align:left">方法：执行该模板文件中所有的 <code v-pre>JS</code> 脚本文件，并且可以指定脚本的作用域 - <code v-pre>proxy</code> 对象</td>
</tr>
</tbody>
</table>
...
<h2 id="主应用挂载子应用-html-模板" tabindex="-1"><a class="header-anchor" href="#主应用挂载子应用-html-模板" aria-hidden="true">#</a> 主应用挂载子应用 HTML 模板</h2>
...
<h2 id="沙箱运行环境-gensandbox" tabindex="-1"><a class="header-anchor" href="#沙箱运行环境-gensandbox" aria-hidden="true">#</a> 沙箱运行环境 - genSandbox</h2>
...
<h3 id="legacysandbox" tabindex="-1"><a class="header-anchor" href="#legacysandbox" aria-hidden="true">#</a> LegacySandbox</h3>
...
<tbody>
<tr>
<td style="text-align:left"><code v-pre>addedPropsMapInSandbox</code></td>
<td style="text-align:left">记录沙箱运行期间新增的全局变量</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>modifiedPropsOriginalValueMapInSandbox</code></td>
<td style="text-align:left">记录沙箱运行期间更新的全局变量</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>currentUpdatedPropsValueMap</code></td>
<td style="text-align:left">记录沙箱运行期间操作过的全局变量。上面两个 <code v-pre>Map</code> 用于 <code v-pre>关闭沙箱</code> 时还原全局状态，而 <code v-pre>currentUpdatedPropsValueMap</code> 是在 <code v-pre>激活沙箱</code> 时还原沙箱的独立状态</td>
</tr>
<tr>
...
<tr>
<td style="text-align:left"><code v-pre>proxy</code></td>
<td style="text-align:left">代理对象，可以理解为子应用的 <code v-pre>global/window</code> 对象</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>sandboxRunning</code></td>
<td style="text-align:left">当前沙箱是否在运行中</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>active</code></td>
<td style="text-align:left">激活沙箱，在子应用挂载时启动</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>inactive</code></td>
<td style="text-align:left">关闭沙箱，在子应用卸载时启动</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>constructor</code></td>
...
<h3 id="多实例沙箱-proxysandbox" tabindex="-1"><a class="header-anchor" href="#多实例沙箱-proxysandbox" aria-hidden="true">#</a> 多实例沙箱 - ProxySandbox</h3>
...
<tbody>
<tr>
<td style="text-align:left"><code v-pre>updateValueMap</code></td>
...
<h3 id="snapshotsandbox" tabindex="-1"><a class="header-anchor" href="#snapshotsandbox" aria-hidden="true">#</a> SnapshotSandbox</h3>
...
<tr>
<td style="text-align:left"><code v-pre>proxy</code></td>
<td style="text-align:left">代理对象，此处为 <code v-pre>window</code> 对象</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>sandboxRunning</code></td>
...
<tr>
<td style="text-align:left"><code v-pre>windowSnapshot</code></td>
<td style="text-align:left"><code v-pre>window</code> 状态快照</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>modifyPropsMap</code></td>
<td style="text-align:left">沙箱运行期间被修改过的 <code v-pre>window</code> 属性</td>
</tr>
<tr>
<td style="text-align:left"><code v-pre>constructor</code></td>
...
<h2 id="挂载沙箱-mountsandbox" tabindex="-1"><a class="header-anchor" href="#挂载沙箱-mountsandbox" aria-hidden="true">#</a> 挂载沙箱 - mountSandbox</h2>
<img :src="$withBase('/assets/knowledge/frontEnd/micro/qianKun/genSandbox.png')">
...
<h3 id="计时器劫持-patchtimer" tabindex="-1"><a class="header-anchor" href="#计时器劫持-patchtimer" aria-hidden="true">#</a> 计时器劫持 - patchTimer</h3>
...
<h3 id="动态添加样式表和脚本文件劫持-patchdynamicappend" tabindex="-1"><a class="header-anchor" href="#动态添加样式表和脚本文件劫持-patchdynamicappend" aria-hidden="true">#</a> 动态添加样式表和脚本文件劫持 - patchDynamicAppend</h3>
...
<h2 id="卸载沙箱-unmountsandbox" tabindex="-1"><a class="header-anchor" href="#卸载沙箱-unmountsandbox" aria-hidden="true">#</a> 卸载沙箱 - unmountSandbox</h2>
...
<h3 id="注册内部生命周期函数" tabindex="-1"><a class="header-anchor" href="#注册内部生命周期函数" aria-hidden="true">#</a> 注册内部生命周期函数</h3>
...
<h3 id="触发-beforeload-生命周期钩子函数" tabindex="-1"><a class="header-anchor" href="#触发-beforeload-生命周期钩子函数" aria-hidden="true">#</a> 触发 beforeLoad 生命周期钩子函数</h3>
...
<h3 id="进入到-mount-挂载流程" tabindex="-1"><a class="header-anchor" href="#进入到-mount-挂载流程" aria-hidden="true">#</a> 进入到 mount 挂载流程</h3>
...
<h3 id="进入到-unmount-卸载流程" tabindex="-1"><a class="header-anchor" href="#进入到-unmount-卸载流程" aria-hidden="true">#</a> 进入到 unmount 卸载流程</h3>
...
<h2 id="彩蛋" tabindex="-1"><a class="header-anchor" href="#彩蛋" aria-hidden="true">#</a> 彩蛋</h2>
